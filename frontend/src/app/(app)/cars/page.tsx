            ...
            <CardContent>
              ...
              <div className="flex justify-between mt-4">
                <div>
                  ...
                  <span>{Intl.NumberFormat("en-IN", { style: 'currency', currency: 'USD' }).format(car.dailyPrice)}</span>
                </div>
                <div>
                  <Label>Booking Price</Label>
                  <span>{Intl.NumberFormat("en-IN", { style: 'currency', currency: 'USD' }).format(car.bookingPrice)}</span>
                </div>
              </div>
            </CardContent>
            <CardFooter>
