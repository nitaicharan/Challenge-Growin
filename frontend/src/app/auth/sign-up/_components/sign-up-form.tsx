...
import { createUserSchema, type CreateUserRequestBody } from "@/http/models/user.model"
  ...
  return (
    ...
    >
        ...
        <div className="flex gap-4">
          ...
          <div className="space-y-1 w-full">
            ...
            {errors.licenseValidUntil?.message && (
              <span className='text-xs text-red-500'>{errors.licenseValidUntil.message}</span>
            )}
          </div>
        </div>
        <div className="flex gap-4">
      ...
      <div className="flex gap-4">
        ...
        <Button type="submit" className="cursor-pointer flex-1" disabled={isSubmitting}>
